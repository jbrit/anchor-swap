...
pub fn get_exchange_info<'info>(
    ...
    match idx {
        0 => {
            let accounts = &accounts[offset as usize..(offset + 9) as usize];
...
pub fn make_generic_swap<'info>(
    idx: u8,
    offset: u8,
    in_amount: Option<u64>,
    minimum_out_amount: u64,
    jupiter_program: &Program<'info, jupiter_cpi::program::Jupiter>,
    ...
    match idx {
        0 => {
            ...
            let end = start + get_exchange_info(idx, offset, accounts).account_count as usize;
